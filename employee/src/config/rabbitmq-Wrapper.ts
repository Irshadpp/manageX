...
//       console.log("Employee Rabbitmq connected!!!");
//     } catch (error) {
    ...
    async connect(): Promise<void> {
        ...
        try {
            ...
            this._channel.connection.on('close', () => {
                console.log('Employee RabbitMQ connection closed. Reconnecting...');
                this._channel = null;
            ...
            this._isConnecting = false;
            console.error('Employee RabbitMQ connection error:', error);
